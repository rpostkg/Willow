...
public class TweakEngineService
{
    ...
    private void CreateRestorePoint()
    {
        string script = @"
            ...
            Start-Process powershell.exe -ArgumentList ""-NoProfile -Command `""Checkpoint-Computer -Description 'System Restore Point created by Willow' -RestorePointType MODIFY_SETTINGS -ErrorAction SilentlyContinue`"""" -WindowStyle Hidden
        ";
